...
//            fileManager.createDirectoryAtPath(archivePath, withIntermediateDirectories: false, attributes: nil, error: &error)
//            if let err = error {
//                println(err.localizedDescription)
//            }
//        }
//        
//        SongStore.sharedStore.loadSongsFromFile()
...
//        SongStore.sharedStore.saveSongsToFile()
        self.saveContext()
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("NoteJam", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("NoteJam.sqlite")
